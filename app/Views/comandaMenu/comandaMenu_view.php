...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col">
				...
				<!--Container Table-->
				<?php require_once('../app/Views/comandaMenu/table.php') ?>
				<!--END container Table-->
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!--FORM-->
					<?php require_once('../app/Views/comandaMenu/form.php') ?>
					<!--END FORM-->
				</div>
	...
	<!--JS CONTROLLER-->	
	<script src="../controllers/ComandaMenu/comandaMenu.js"></script>
	</main>
